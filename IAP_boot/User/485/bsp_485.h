...
/* DE/RE 极性选择：1=高电平发送(常见)，0=低电平发送(部分模块) */
#define _485_DIR_TX_ACTIVE_HIGH  1
#if _485_DIR_TX_ACTIVE_HIGH
  //串口接收模式
...
#else
  //串口接收模式
  #define _485_RX_EN()      _485_delay(1000); GPIO_SetBits(_485_RE_GPIO_PORT,_485_RE_PIN);   _485_delay(1000);
  //串口发送模式
  #define _485_TX_EN()      _485_delay(1000); GPIO_ResetBits(_485_RE_GPIO_PORT,_485_RE_PIN); _485_delay(1000);
#endif
